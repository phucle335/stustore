...
| UI | React 19, CSS Modules under `styles/components/` (see [2026/05/29-styling-css-modules.md](./2026/05/29-styling-css-modules.md)) |
...
app/
  ...
  layout.tsx               # Root layout (ToastProvider, CartProvider, globals.css)
  page.tsx                 # Homepage (MottoHomePage)

components/
  home/                    # Homepage sections
  store/                   # Header, cart, mobile chrome (bottom nav, drawers), product grid, modals
...
Category and product pages use `StoreShell` for header, commitment bar, mobile chrome (bottom nav, menu/search overlays, login modal), and footer. See [29-styling-css-modules.md § Mobile chrome](./2026/05/29-styling-css-modules.md#mobile-chrome-bottom-nav--overlays).
